...
export function AdminCatalogNavigation({ q }: AdminCatalogNavigationProps) {
  ...
  return (
    <nav aria-label="Secciones de Gestión de catálogo" className="sticky top-0 z-10 -mx-4 bg-[#f7f8fa]/95 px-4 py-2 backdrop-blur sm:static sm:mx-0 sm:bg-transparent sm:px-0 sm:py-0 sm:backdrop-blur-none">
