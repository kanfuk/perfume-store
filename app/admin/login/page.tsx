  ...
  return (
    <main className="min-h-[100dvh] bg-[#f7f1e8]">
      <div className="grid lg:min-h-[calc(100dvh-72px)] lg:grid-cols-[0.9fr_1.1fr]">
        <section className="relative isolate flex overflow-hidden bg-[#0b0b0b] px-6 py-8 text-white sm:px-10 lg:items-end lg:p-14">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-16 hidden lg:block">
              <SmellmeLogo className="mb-8 h-32 w-44 border border-[#e8c79e]/15 shadow-[0_24px_60px_rgba(0,0,0,0.4)]" />
