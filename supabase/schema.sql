...
comment on column public.productos.stock_reservado is
  'Unidades comprometidas por pedidos NUEVO/AGENDADO todavia no pagados. Mantenida por las RPC de supabase/migrations/20260724010000_perfume_store_transactional_stock.sql. Disponible para nueva reserva = stock_actual - stock_reservado.';
...
comment on column public.pedidos.stock_repuesto is
  'Bandera de idempotencia: cancel_perfume_order_v1 la usa para no liberar ni reponer stock dos veces sobre el mismo pedido.';
...
-- ============================================================
-- Fase 1C: stock transaccional y RPC de pedidos.
-- Espejo de supabase/migrations/20260724010000_perfume_store_transactional_stock.sql.
-- Modelo: stock_actual = fisico; stock_reservado = comprometido por pedidos
-- sin pagar; disponible = stock_actual - stock_reservado. Ver
...
-- ============================================================
-- Smellme MVP V2: espejo de la migración de mantenimiento seguro.
-- ============================================================
...
-- ============================================================
-- Smellme 2.0.0-rc.2: espejo del reinicio operacional total.
-- ============================================================
