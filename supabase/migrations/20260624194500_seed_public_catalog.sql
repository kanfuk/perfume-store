...
from (
  values
    ...
    ('Quequito marmoleado', 'Suave bizcocho humedo y esponjoso con sabor vainilla y chocolate.', 1000, '/images/products/quequito-marmoleado.png', 'QUEQUITO CASERO', 450, 0, 0, true, 'quequito'),
    ('Quequito banana bread', 'Rico bizcocho esponjoso, humedo, con platano y nueces.', 1000, '/images/products/quequito-banana-bread.png', 'QUEQUITO CASERO', 470, 0, 0, true, 'quequito'),
    ('Quequito choco chip sugar free', 'Bizcocho de vainilla endulzado con alulosa, con chips de chocolate semi amargo.', 1000, '/images/products/quequito-choco-chip-sugar-free.png', 'SUGAR FREE', 520, 0, 0, true, 'quequito'),
    ('Carrot cake con nueces', 'Porcion casera de carrot cake con nueces.', 1000, '/images/products/carrot-cake-nueces.png', 'QUEQUITO CASERO', 490, 0, 0, true, 'quequito'),
    ('Queque de platano', 'Queque entero de platano. Precio pendiente de confirmacion.', 0, '/images/products/queque-platano.png', 'PRECIO PENDIENTE', 1600, 0, 0, false, 'queque'),
    ('Queque marmoleado', 'Queque entero marmoleado. Precio pendiente de confirmacion.', 0, '/images/products/queque-marmoleado.png', 'PRECIO PENDIENTE', 1650, 0, 0, false, 'queque'),
    ('Pedido personalizado', 'Producto especial o a pedido definido por Pauli desde admin.', 0, '/images/products/pedido-personalizado.png', 'A PEDIDO', 0, 0, 0, false, 'personalizado')
) as seed (
  nombre,
  descripcion,
  precio_venta,
